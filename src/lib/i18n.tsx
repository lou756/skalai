...
const translations = {
  fr: {
    ...
    'hero.stat.categories': 'Catégories SEO',
    'hero.stat.realData': 'Données réelles',
    'hero.stat.transparency': 'Transparence',
    // Features
    ...
    'about.tech.desc': 'Crawl web via Firecrawl, analyse IA via Gemini, scoring pondéré positif sur 9 catégories, découverte exhaustive des URLs, extraction de données structurées JSON-LD, Core Web Vitals via Google PageSpeed Insights.',
    ...
    'detail.sitemapCrossDomain': 'Sitemap hébergé sur un domaine externe',
    'detail.sitemapCrossDomainDesc': 'Votre sitemap est hébergé sur {domain} au lieu de votre propre domaine. Hébergez-le sur votre site et mettez à jour le robots.txt.',
    'detail.sitemapForeignUrls': '{count} URL(s) d\'autres domaines dans le sitemap',
    'detail.sitemapForeignUrlsDesc': 'Google ignore les URLs du sitemap qui ne correspondent pas à votre domaine. Supprimez-les pour optimiser le crawl.',
    'detail.yes': 'Oui',
    'detail.no': 'Non',
    ...
    'method.tech.pagespeed': 'Mesure des Core Web Vitals (LCP, FCP, TBT, CLS) via l\'API Google PageSpeed Insights.',
    ...
    'method.step5.desc': 'Le score est calculé positivement sur 9 catégories pondérées. Chaque point gagné est justifié par une vérification réelle.',
    ...
    'auth.adminAccess': 'Accédez au back office SKAL IA pour consulter l\'historique des analyses.',
    'auth.email': 'Email',
    ...
    // Admin
    'admin.title': 'Back Office — Historique des analyses',
    'admin.logout': 'Déconnexion',
    'admin.allSites': 'Tous les sites',
    'admin.scanHistory': 'Historique des scans',
    'admin.navAdmin': 'Admin',
    // Sitemap hosting
    'fixes.sitemapUrl': 'URL du sitemap',
    'fixes.copyUrl': 'Copier l\'URL',
    'fixes.urlCopied': 'URL copiée !',
    'fixes.hosting': 'Hébergement en cours...',
    'fixes.hosted': 'Hébergé — URL disponible',
    // GSC/Merchant detection
    'gsc.detected': 'Google Search Console détecté',
    'gsc.notDetected': 'Google Search Console non détecté',
    'gsc.guide': 'Guide d\'activation',
    'gsc.positiveSignals': '{found}/{total} signaux positifs. Forte probabilité que GSC soit configuré.',
    'gsc.insufficientSignals': 'Signaux insuffisants pour confirmer la configuration de Google Search Console.',
    'gsc.showSignals': 'Voir les {count} signaux analysés',
    'gsc.eligibilityProbable': 'Éligibilité probable',
    'gsc.partialSignals': 'Signaux partiels',
    'gsc.unlikely': 'Peu probable',
    'gsc.notDetectedLabel': 'Non détecté',
    'merchant.detected': 'Google Merchant Center détecté',
    'merchant.notDetected': 'Google Merchant Center non détecté',
    'merchant.guide': 'Guide d\'activation',
    'merchant.eligibility': 'Éligibilité Merchant Center',
    'merchant.notEcommerce': 'Site non e-commerce',
    'merchant.signalsDetected': '{found}/{total} signaux détectés. {pages} URL(s) produit, {products} produit(s) analysés.',
    'merchant.noSignals': 'Aucun signal e-commerce détecté. Si vous vendez des produits, configurez Google Merchant Center.',
    'merchant.showSignals': 'Voir les {count} signaux analysés',
    'merchant.weight': 'poids',
    'merchant.technicalEligibility': 'Cette analyse vérifie l\'éligibilité technique au Merchant Center (balisage, structure, signaux). Elle ne peut pas confirmer si un compte Merchant Center est réellement actif, car cette information n\'est pas publique.',
    'merchant.complianceTitle': 'Conformité Merchant Center',
    'merchant.complianceCriteria': '{found}/{total} critères',
    'merchant.complianceDesc': 'Vérification des pages et critères métier requis par Google Merchant Center pour l\'approbation des produits.',
    'merchant.showCriteria': 'Voir les {count} critères vérifiés',
    'merchant.contentValid': 'Contenu conforme',
    'merchant.contentInsufficient': 'Contenu insuffisant',
    'merchant.notAnalyzed': 'Non analysé',
    'merchant.complianceDisclaimer': 'Chaque page de politique est scrapée et analysée par IA pour vérifier la conformité du contenu aux exigences Google Merchant Center. Un score de 100% indique que toutes les pages sont présentes et leur contenu répond aux critères. L\'approbation finale reste à la discrétion de Google.',
    // Schema/Redirect sections
    'schema.title': 'Schema.org / Données structurées',
    'schema.types': 'type(s)',
    'schema.valid': 'Valide',
    'schema.issues': 'problème(s)',
    'schema.validCount': '{valid}/{total} type(s) valide(s)',
    'schema.noData': 'Aucune donnée structurée JSON-LD détectée.',
    'schema.recommendations': 'Recommandations',
    'redirect.title': 'Redirections',
    'redirect.noRedirect': 'Aucune redirection détectée. L\'URL est directement accessible.',
    'redirect.finalUrl': 'URL finale',
    // GSC steps
    'gsc.step1': 'Accédez à Google Search Console',
    'gsc.step2': 'Cliquez sur "Ajouter une propriété" et entrez votre domaine',
    'gsc.step3': 'Vérifiez la propriété via l\'une des méthodes proposées (DNS, balise HTML, fichier HTML, Google Analytics, Google Tag Manager).',
    'gsc.step4': 'Une fois vérifié, soumettez votre sitemap',
    'gsc.step5': 'Attendez 24-48h pour que Google indexe votre site. Consultez le rapport de couverture pour voir les pages indexées.',
    // Merchant steps
    'merchant.step1': 'Accédez à Google Merchant Center',
    'merchant.step2': 'Créez un compte ou connectez-vous, puis ajoutez les informations de votre entreprise.',
    'merchant.step3': 'Vérifiez et revendiquez l\'URL de votre site web.',
    'merchant.step4': 'Ajoutez vos produits via un flux de données (le fichier CSV a été généré par SKAL IA si des produits ont été détectés).',
  ...
  en: {
    ...
    'hero.stat.categories': 'SEO categories',
    'hero.stat.realData': 'Real data',
    'hero.stat.transparency': 'Transparency',
    ...
    'about.tech.title': 'Technologies',
    'about.tech.desc': 'Web crawling via Firecrawl, AI analysis via Gemini, weighted positive scoring across 9 categories, exhaustive URL discovery, JSON-LD structured data extraction, Core Web Vitals via Google PageSpeed Insights.',
    ...
    'detail.sitemapCrossDomain': 'Sitemap hosted on external domain',
    'detail.sitemapCrossDomainDesc': 'Your sitemap is hosted on {domain} instead of your own domain. Host it on your site and update robots.txt.',
    'detail.sitemapForeignUrls': '{count} URL(s) from other domains in sitemap',
    'detail.sitemapForeignUrlsDesc': 'Google ignores sitemap URLs that don\'t match your domain. Remove them to optimize crawling.',
    'detail.yes': 'Yes',
    'detail.no': 'No',
    ...
    'method.tech.pagespeed': 'Core Web Vitals measurement (LCP, FCP, TBT, CLS) via Google PageSpeed Insights API.',
    ...
    'method.step5.desc': 'The score is positively calculated across 9 weighted categories. Every earned point is justified by a real verification.',
    ...
    'auth.adminAccess': 'Access the SKAL IA back office to view scan history.',
    'auth.email': 'Email',
    ...
    // Admin
    'admin.title': 'Back Office — Scan History',
    'admin.logout': 'Sign Out',
    'admin.allSites': 'All sites',
    'admin.scanHistory': 'Scan History',
    'admin.navAdmin': 'Admin',
    // Sitemap hosting
    'fixes.sitemapUrl': 'Sitemap URL',
    'fixes.copyUrl': 'Copy URL',
    'fixes.urlCopied': 'URL copied!',
    'fixes.hosting': 'Hosting...',
    'fixes.hosted': 'Hosted — URL available',
    // GSC/Merchant detection
    'gsc.detected': 'Google Search Console detected',
    'gsc.notDetected': 'Google Search Console not detected',
    'gsc.guide': 'Activation guide',
    'gsc.positiveSignals': '{found}/{total} positive signals. GSC is likely configured.',
    'gsc.insufficientSignals': 'Insufficient signals to confirm Google Search Console configuration.',
    'gsc.showSignals': 'View {count} analyzed signals',
    'gsc.eligibilityProbable': 'Likely eligible',
    'gsc.partialSignals': 'Partial signals',
    'gsc.unlikely': 'Unlikely',
    'gsc.notDetectedLabel': 'Not detected',
    'merchant.detected': 'Google Merchant Center detected',
    'merchant.notDetected': 'Google Merchant Center not detected',
    'merchant.guide': 'Activation guide',
    'merchant.eligibility': 'Merchant Center Eligibility',
    'merchant.notEcommerce': 'Non e-commerce site',
    'merchant.signalsDetected': '{found}/{total} signals detected. {pages} product URL(s), {products} product(s) analyzed.',
    'merchant.noSignals': 'No e-commerce signals detected. If you sell products, set up Google Merchant Center.',
    'merchant.showSignals': 'View {count} analyzed signals',
    'merchant.weight': 'weight',
    'merchant.technicalEligibility': 'This analysis checks technical eligibility for Merchant Center (markup, structure, signals). It cannot confirm whether a Merchant Center account is actually active, as this information is not public.',
    'merchant.complianceTitle': 'Merchant Center Compliance',
    'merchant.complianceCriteria': '{found}/{total} criteria',
    'merchant.complianceDesc': 'Verification of pages and business criteria required by Google Merchant Center for product approval.',
    'merchant.showCriteria': 'View {count} verified criteria',
    'merchant.contentValid': 'Content compliant',
    'merchant.contentInsufficient': 'Content insufficient',
    'merchant.notAnalyzed': 'Not analyzed',
    'merchant.complianceDisclaimer': 'Each policy page is scraped and analyzed by AI to verify content compliance with Google Merchant Center requirements. A score of 100% indicates all pages are present and their content meets the criteria. Final approval remains at Google\'s discretion.',
    // Schema/Redirect sections
    'schema.title': 'Schema.org / Structured Data',
    'schema.types': 'type(s)',
    'schema.valid': 'Valid',
    'schema.issues': 'issue(s)',
    'schema.validCount': '{valid}/{total} valid type(s)',
    'schema.noData': 'No JSON-LD structured data detected.',
    'schema.recommendations': 'Recommendations',
    'redirect.title': 'Redirects',
    'redirect.noRedirect': 'No redirects detected. The URL is directly accessible.',
    'redirect.finalUrl': 'Final URL',
    // GSC steps
    'gsc.step1': 'Go to Google Search Console',
    'gsc.step2': 'Click "Add a property" and enter your domain',
    'gsc.step3': 'Verify the property using one of the proposed methods (DNS, HTML tag, HTML file, Google Analytics, Google Tag Manager).',
    'gsc.step4': 'Once verified, submit your sitemap',
    'gsc.step5': 'Wait 24-48h for Google to index your site. Check the coverage report to see indexed pages.',
    // Merchant steps
    'merchant.step1': 'Go to Google Merchant Center',
    'merchant.step2': 'Create an account or sign in, then add your business information.',
    'merchant.step3': 'Verify and claim your website URL.',
    'merchant.step4': 'Add your products via a data feed (the CSV file was generated by SKAL IA if products were detected).',
